DROP TABLE IF EXISTS `qcy_queue`;
CREATE TABLE `qcy_queue` (
...
DROP TABLE IF EXISTS `qcy_web_seed`;
CREATE TABLE `qcy_web_seed` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `qcy_web_seed_internally`;
CREATE TABLE `qcy_web_seed_internally` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `url` varchar(2000) NOT NULL COMMENT '种子URL',
  `md5` varchar(40) NOT NULL COMMENT '种子URL的MD5',
...
DROP TABLE IF EXISTS `qcy_web_seed_externally`;
CREATE TABLE `qcy_web_seed_externally` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `url` varchar(2000) NOT NULL COMMENT '种子URL',
  `md5` varchar(40) NOT NULL COMMENT '种子URL的MD5',
  `param` text COMMENT '参数预留',
...
DROP TABLE IF EXISTS `qcy_web_page`;
CREATE TABLE `qcy_web_page` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
